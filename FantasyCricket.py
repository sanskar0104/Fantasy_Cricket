...
class AppDemo(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowIcon(QtGui.QIcon('Images1.png'))
        self.resize(1250,650)
        self.setWindowTitle("THE CRICKET FANTASEA")
        self.setStyleSheet("background-color: #87CEFA")
        linkTemplate = '<a href={0}>{1}</a>'
        self.label = QLabel(self)
        self.label.move(20,190)
        self.label.setPixmap(QPixmap("Images.png").scaled(290, 290, Qt.KeepAspectRatio,Qt.SmoothTransformation))
        self.label1 = QLabel(self)
        self.label1.setPixmap(QPixmap("Images1.png").scaled(275, 275, Qt.KeepAspectRatio,Qt.SmoothTransformation))
        self.label1.move(1000,225)        
        button = QPushButton("❌CLOSE❌", self)
        button.clicked.connect(self.close)
        button.move(550,592)
        button.setStyleSheet("QPushButton"
                             "{"
                              "background:#005CF2;color:white;border-style: outset;border-width: 2px;border-radius: 10px;font: bold 18px;min-width: 5em;padding: 4px;border-color: black;"
                             "}"
                             "QPushButton::pressed"
                             "{"
                             "background:#8db3f0;color:white;border-style: outset;border-width: 2px;border-radius: 10px;font: bold 18px;min-width: 5em;padding: 4px;border-color: black;"
                             "}"
                             )
        button.resize(120,38)
        label = QLabel(self)
        label1= QLabel(self)
        label2= QLabel(self)
        label3= QLabel(self)
        ...
        label12=QLabel(self)
        label13=QLabel(self)
        label6 = HyperlinkLabel(self)
        label7 = HyperlinkLabel(self)
        label8 = HyperlinkLabel(self)
        label9 = HyperlinkLabel(self)
        label11= HyperlinkLabel(self)
        label14= HyperlinkLabel(self)
        label.setText("  THE GAME OF BIG BRAINS THE GAME OF BIG BRAINS THE GAME OF BIG BRAINS  ")
        label.setStyleSheet('font-size: 25px; color: #f2273b;text-decoration: underline,overline')
        label.move(150,17)
        label1.setText('*****✌✌FANTASY CRICKET GAME✌✌*****')  
        label1.setStyleSheet('font-size: 55px;color: #450769;border-style: solid;border-width: 5px;border-radius: 10px;border-color: #130040;')  
        label1.move(35,75)  
        label10.setText("💪HOME PAGE")
        label10.setStyleSheet('font-size: 28px; color:#0c6905;text-decoration: underline')
        label10.move(265,200)
        label2.setText("💪HOW TO PLAY")
        label2.setStyleSheet('font-size: 28px; color:#0c6905;text-decoration: underline')
        label2.move(265,250)
        label3.setText("💪RULES")
        label3.setStyleSheet('font-size: 28px;color:#0c6905;text-decoration: underline')
        label3.move(265,300)
        label4.setText("💪REGISTRATION/LOGIN")
        label4.setStyleSheet('font-size: 28px;color:#0c6905;text-decoration: underline')
        label4.move(265,350)
        label5.setText("💪PLAYER PROFILES")
        label5.setStyleSheet('font-size: 28px;color:#0c6905;text-decoration: underline')
        label5.move(265,400)
        label13.setText("💪TERMS AND CONDITIONS")
        label13.setStyleSheet('font-size: 28px;color:#0c6905;text-decoration: underline')
        label13.move(265,450)
        label11.setText(linkTemplate.format('http://localhost/fin/home/index.php', '👉CLICK HERE👈'))  
        label11.setStyleSheet('font-size: 35px')    
        label11.move(690,200)
        label6.setText(linkTemplate.format('http://localhost/fin/home/index.php', '👉CLICK HERE👈'))  
        label6.setStyleSheet('font-size: 35px')    
        label6.move(690,250)
        label7.setText(linkTemplate.format('http://localhost/fin/home/index.php', '👉CLICK HERE👈'))  
        label7.setStyleSheet('font-size: 35px')    
        label7.move(690,300)
        label8.setText(linkTemplate.format('http://localhost/fin/home/index.php', '👉CLICK HERE👈'))  
        label8.setStyleSheet('font-size: 35px')    
        label8.move(690,350)
        label9.setText(linkTemplate.format('http://localhost/fin/home/index.php', '👉CLICK HERE👈'))  
        label9.setStyleSheet('font-size: 35px')    
        label9.move(690,400)
        label14.setText(linkTemplate.format('http://localhost/fin/home/index.php', '👉CLICK HERE👈'))  
        label14.setStyleSheet('font-size: 35px')    
        label14.move(690,450)
        label12.setText("IF ALL THE TERMS AND CONDITIONS ARE ACCEPTABLE AND THE USER IS REGISTERED THEN KINDLY CLOSE THIS WINDOW\n                                THE NEXT SCREEN AWAITS YOUR CRICKET TEAM FANTASY APPLICATION!!!")
        label12.setStyleSheet('font-size: 20px; color:purple;border: 4px double Black;')
        label12.move(50,525)
...
6. You can "Directly" create New Team after saving (No need to click 'New Team' Again)'''
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "THE CRICKET FANTASEA"))
